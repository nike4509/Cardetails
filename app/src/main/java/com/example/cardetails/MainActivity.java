...
private Button btnCreateCar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtMake = findViewById(R.id.txtManufacturer);
        txtYear = findViewById(R.id.txtYearmanufactured);
        txtColor = findViewById(R.id.txtColor);
        txtPurchasePrice = findViewById(R.id.txtprics);
        txtEngineSize = findViewById(R.id.txtEngineSize);

        txtScrollable = findViewById(R.id.txtscrolling);
